...
class TestOrganizationResource:
    def test_get_organizations(self, client, organization, organization_hh, mocker):
        mocker.patch(
    ...
    def test_get_one_organization(self, client, organization, mocker):
        mocker.patch(
            "authlib.integrations.flask_oauth2.resource_protector.ResourceProtector.acquire_token",
            return_value=True,
        )
    ...
    def test_post_with_empty_body(self, client, mocker):
        mocker.patch(
            "authlib.integrations.flask_oauth2.resource_protector.ResourceProtector.acquire_token",
            return_value=True,
        )
    ...
    def test_post_with_invalid_data(self, client, mocker):
        mocker.patch(
            "authlib.integrations.flask_oauth2.resource_protector.ResourceProtector.acquire_token",
            return_value=True,
        )
    ...
    def test_delete_organization(self, client, organization_hh, mocker):
        mocker.patch(
            "authlib.integrations.flask_oauth2.resource_protector.ResourceProtector.acquire_token",
            return_value=True,
        )
    ...
    def test_post_organization(self, client, mocker):
        mocker.patch(
            "authlib.integrations.flask_oauth2.resource_protector.ResourceProtector.acquire_token",
            return_value=True,
        )
    ...
    def test_patch_and_put_organization(self, client, organization_hh, mocker):
        mocker.patch(
            "authlib.integrations.flask_oauth2.resource_protector.ResourceProtector.acquire_token",
            return_value=True,
        )
